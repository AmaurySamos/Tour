...
var bg3 = require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/background/bg6.jpg');
									...
									<SimpleReactLightbox>
										<SRLWrapper >
											<ul className="clearfix mfp-gallery">
												<li className="img-effect2"><Link to={''} className="mfp-link" title="Title Come Here"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img1.jpg')} alt="" /></Link> </li>
												<li className="img-effect2"><Link to={''} className="mfp-link" title="Title Come Here"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img2.jpg')} alt="" /></Link> </li>
												<li className="img-effect2"><Link to={''} className="mfp-link" title="Title Come Here"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img3.jpg')} alt="" /></Link> </li>
												<li className="img-effect2"><Link to={''} className="mfp-link" title="Title Come Here"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img4.jpg')} alt="" /></Link> </li>
												<li className="img-effect2"><Link to={''} className="mfp-link" title="Title Come Here"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img5.jpg')} alt="" /></Link> </li>
												<li className="img-effect2"><Link to={''} className="mfp-link" title="Title Come Here"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img6.jpg')} alt="" /></Link> </li>
												<li className="img-effect2"><Link to={''} className="mfp-link" title="Title Come Here"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img7.jpg')} alt="" /></Link> </li>
												<li className="img-effect2"><Link to={''} className="mfp-link" title="Title Come Here"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img8.jpg')} alt="" /></Link> </li>
												<li className="img-effect2"><Link to={''} className="mfp-link" title="Title Come Here"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img9.jpg')} alt="" /></Link> </li>
											</ul>
										</SRLWrapper>
									</SimpleReactLightbox>
                                </div>
