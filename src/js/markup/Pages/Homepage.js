...
import Header from 'C:/Users/Amy/Desktop/Tour/tour-project/src/js/markup/Layout/Header';
import Footer from 'C:/Users/Amy/Desktop/Tour/tour-project/src/js/markup/Layout/Footer';
...
var bg3 = require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/background/bg3.jpg');
                        ...
                        <div className="container">
                            ...
                            <div className="row packages">
                                <div className="col-lg-6 col-xl-3 col-sm-6 col-md-6 m-b30">
                                    <div className="dlab-box">
                                        <div className="dlab-media">
                                            <Link><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img4.jpg')} alt="" /></Link>
                                        </div>
                                ...
                                <div className="col-lg-6 col-xl-3 col-sm-6 col-md-6 m-b30">
                                    <div className="dlab-box">
                                        <div className="dlab-media">
                                            <Link><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img3.jpg')} alt="" /></Link>
                                        </div>
                                        <div className="dlab-info p-a15 border-1">
                                ...
                                <div className="col-lg-6 col-xl-3 col-sm-6 col-md-6 m-b30">
                                    <div className="dlab-box">
                                        <div className="dlab-media">
                                            <Link><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img5.jpg')} alt="" /></Link>
                                        </div>
                                        <div className="dlab-info p-a15 border-1">
                                ...
                                <div className="col-lg-6 col-xl-3 col-sm-6 col-md-6 m-b30">
                                    <div className="dlab-box">
                                        <div className="dlab-media">
                                            <Link><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img6.jpg')} alt="" /></Link>
                                        </div>
                                        <div className="dlab-info p-a15 border-1">
