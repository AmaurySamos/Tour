...
var bg3 = require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/background/bg5.jpg');
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-6">
                            <img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/collage.png')} alt="" />
                        </div>
                    </div>
                </div>
            </div>
