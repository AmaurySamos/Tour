                ...
                <div className="content-block">
                    <div className="section-full content-inner overlay-white-middle">
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="col-lg-6 col-md-6 col-sm-6 m-b30 col-12"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/blog/default/thum2.jpg')} alt="" /></div>
                                <div className="col-lg-6 col-md-6 col-sm-6 m-b30 col-12"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/blog/default/thum3.jpg')} alt="" /></div>
                            </div>
                            <div className="row">
