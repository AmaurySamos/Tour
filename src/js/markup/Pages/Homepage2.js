...
const content = [
    {
        ...
        image: require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/main-slider/slide1.jpg'),
    },
    {
        button: '-25% OFF ONLY THIS MONTH',
        title: 'SEA TOURS ONLY THIS MONTH',
		description: 'Discover amzaing places at exclusive deals',
        image: require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/main-slider/slide2.jpg'),
    },
    {
        button: '-25% OFF ONLY THIS MONTH',
        title: 'SEA TOURS ONLY THIS MONTH',
		description: 'Discover amzaing places at exclusive deals',
        image: require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/main-slider/slide3.jpg'),
    }
];
...
var bg1 = require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/background/bg1.jpg');
                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-6 col-sm-12">
                                    <div className="featured-bx style2">
                                        <div className="featured-media">
                                            <img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/featured/pic1.jpg')} alt="" />
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-12">
                                    <div className="featured-bx style2">
                                        <div className="featured-media">
                                            <img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/featured/pic4.jpg')} alt="" />
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12">
                                    <div className="featured-bx style2">
                                        <div className="featured-media">
                                            <img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/featured/pic5.jpg')} alt="" />
                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="dlab-box packages-bx">
                                        <div className="dlab-media">
                                            <Link to={'listing-details-1'}><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img5.jpg')} alt="" /></Link>
                                    ...
                                    <div className="dlab-box packages-bx">
                                        <div className="dlab-media">
                                            <Link to={'listing-details-1'}><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img2.jpg')} alt="" /></Link>
                                            <span className="tag yellow">Best Seller</span>
                                        </div>
                                        <div className="dlab-info">
                                            <div className="head-title">
                                ...
                                <div className="col-lg-6">
                                    <div className="dlab-box packages-bx">
                                        <div className="dlab-media">
                                            <Link to={'listing-details-1'}><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img3.jpg')} alt="" /></Link>
                                            <span className="tag yellow">Best Seller</span>
                                        </div>
                                        <div className="dlab-info">
                                            <div className="head-title">
                                ...
                                <div className="col-lg-6">
                                    <div className="dlab-box packages-bx">
                                        <div className="dlab-media">
                                            <Link to={'listing-details-1'}><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/img4.jpg')} alt="" /></Link>
                                            <span className="tag yellow">Best Seller</span>
                                        </div>
                                        <div className="dlab-info">
                                            <div className="head-title">
