...
var bg3 = require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/banner/bnr1.jpg');
                        ...
                        <div className="row">
                            <div className="col-lg-8 col-md-7 m-b10">
                                <div className="blog-post blog-single blog-style-1">
                                    ...
                                    <div className="dlab-post-media dlab-img-effect zoom-slow m-t20"> <Link><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/blog/default/thum1.jpg')} alt="" /></Link> </div>
                                    ...
                                    It has urvived not only five centuries, but also the leap into electronic typesetting.</p>
                                        ...
                                        <img className="alignleft wow fadeIn blog-side-img" data-wow-delay="0.2s" src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/blog/grid/pic4.jpg')} alt="" />
                                    ...
                                    It was popularised in the 1960s with the release</p>
                                        ...
                                        <img className="alignright wow fadeIn blog-side-img" data-wow-delay="0.2s" src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/blog/grid/pic1.jpg')} alt="" />
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                            ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only
                                            five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release
                                            of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like
                                            ...
                                            <ol className="comment-list">
                                                <li className="comment">
                                                    <div className="comment-body">
                                                        <div className="comment-author vcard"> <img className="avatar photo" src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/testimonials/pic1.jpg')} alt="" /> <cite className="fn">Stacy poe</cite> <span className="says">says:</span> </div>
                                                    ...
                                                    <ol className="children">
                                                        <li className="comment odd parent">
                                                            <div className="comment-body">
                                                                <div className="comment-author vcard"> <img className="avatar photo" src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/testimonials/pic2.jpg')} alt="" /> <cite className="fn">Stacy poe</cite> <span className="says">says:</span> </div>
                                                                <div className="comment-meta"> <Link>October 6, 2015 at 7:15 am</Link> </div>
                                                            ...
                                                            <ol className="children">
                                                                <li className="comment odd parent">
                                                                    <div className="comment-body">
                                                                        <div className="comment-author vcard"> <img className="avatar photo" src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/testimonials/pic3.jpg')} alt="" /> <cite className="fn">Stacy poe</cite> <span className="says">says:</span> </div>
                                                                        <div className="comment-meta"> <Link>October 6, 2015 at 7:15 am</Link> </div>
                                                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae neque vitae sapien malesuada aliquet.
                                                                            In viverra dictum justo in vehicula. Fusce et massa eu ante ornare molestie. Sed vestibulum sem felis,
                                                                    ac elementum ligula blandit ac.</p>
                            ...
                            <div className="col-lg-4 col-md-5 sticky-top">
                                <aside className="side-bar">
                                    ...
                                    <div className="widget recent-posts-entry">
                                        ...
                                        <div className="widget-post-bx">
                                            <div className="widget-post clearfix">
                                                <div className="dlab-post-media"> <img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/blog/recent-blog/pic1.jpg')} width="200" height="143" alt="" /> </div>
                                            ...
                                            <div className="widget-post clearfix">
                                                <div className="dlab-post-media"> <img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/blog/recent-blog/pic2.jpg')} width="200" height="160" alt="" /> </div>
                                                <div className="dlab-post-info">
                                                    <div className="dlab-post-header">
                                            ...
                                            <div className="widget-post clearfix">
                                                <div className="dlab-post-media"> <img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/blog/recent-blog/pic3.jpg')} width="200" height="160" alt="" /> </div>
                                                <div className="dlab-post-info">
                                                    <div className="dlab-post-header">
                                    ...
                                    <div className="widget widget_gallery gallery-grid-3">
                                        ...
                                        <ul>
                                            <li><div className="dlab-post-thum"><Link className="dlab-img-overlay1 dlab-img-effect zoom-slow"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/pic2.jpg')} alt="" /></Link></div></li>
                                            <li><div className="dlab-post-thum"><Link className="dlab-img-overlay1 dlab-img-effect zoom-slow"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/pic1.jpg')} alt="" /></Link></div></li>
                                            <li><div className="dlab-post-thum"><Link className="dlab-img-overlay1 dlab-img-effect zoom-slow"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/pic5.jpg')} alt="" /></Link></div></li>
                                            <li><div className="dlab-post-thum"><Link className="dlab-img-overlay1 dlab-img-effect zoom-slow"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/pic7.jpg')} alt="" /></Link></div></li>
                                            <li><div className="dlab-post-thum"><Link className="dlab-img-overlay1 dlab-img-effect zoom-slow"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/pic8.jpg')} alt="" /></Link></div></li>
                                            <li><div className="dlab-post-thum"><Link className="dlab-img-overlay1 dlab-img-effect zoom-slow"><img src={require('C:/Users/Amy/Desktop/Tour/tour-project/src/images/gallery/pic9.jpg')} alt="" /></Link></div></li>
                                        </ul>
                                    </div>
